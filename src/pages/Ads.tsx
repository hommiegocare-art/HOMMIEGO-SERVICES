...
interface Ad {
  id: string;
  user_id: string; // ADDED: to check ownership
  title: string;
  caption: string | null;
  image_url: string;
  link: string | null;
...
export default function CreateAd() {
  ...
  // Fetch all active ads AND current user
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
            ...
            <Button
              ...
              className="rounded-xl shadow-lg shadow-primary/20 gap-2 px-8 dark:shadow-primary/10"
            >
          ...
          {/* Form Panel */}
          {showPanel && (
            <Card className="border border-slate-200 dark:border-slate-800 bg-white dark:bg-gray-950 shadow-xl rounded-xl overflow-hidden mb-2 animate-in slide-in-from-top-10 duration-500">
              ...
              <CardContent className="p-8">
                <form onSubmit={handleCreateAd} className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                  <div className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        required
                        className="h-12 rounded-xl bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500"
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        className="rounded-xl min-h-[100px] bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500"
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        id="link"
                        placeholder="https://yourwebsite.com or /explore"
                        value={link}
                  ...
                  <div className="space-y-4">
                    ...
                    <label className="relative group cursor-pointer border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-[2rem] h-[280px] flex flex-col items-center justify-center bg-slate-50 dark:bg-gray-950 hover:bg-slate-100 dark:hover:bg-slate-800 hover:border-primary transition-all overflow-hidden">
                      {preview ? (
          ...
          <div className="space-y-6">
            ...
            {adsLoading ? (
              ...
              <Card className="border-dashed border-slate-200 dark:border-slate-700 bg-transparent dark:bg-gray-950/30 p-20 text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {ads.map((ad) => (
                  <Card
                    key={ad.id}
                    className="group overflow-hidden rounded-[2rem] bg-white dark:bg-gray-950 border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-xl dark:hover:shadow-black/20 transition-all duration-300"
                  >
                    ...
                    <CardContent className="p-6">
                      <div className="flex justify-between items-start gap-4">
                        ...
                        {/* DELETE BUTTON: Only visible to ad owner */}
                        {currentUserId === ad.user_id && (
                          <Button
                            variant="ghost"
                            size="icon"
                            onClick={() => deleteAd(ad.id)}
                            className="text-slate-300 dark:text-slate-600 hover:text-destructive hover:bg-destructive/10 rounded-xl"
                          >
