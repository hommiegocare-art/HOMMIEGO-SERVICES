        ...
        <div className="min-h-screen bg-[#F8FAFC]">
            ...
            <div className="max-w-4xl mx-auto px-4 pt-32 pb-20">
                <div className="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/60 overflow-hidden border border-slate-100">
                    ...
                    <div className="bg-white p-10 md:p-16 text-black relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <h1 className="text-4xl md:text-5xl font-black mb-4 tracking-tight">
                                Work at <span className="text-primary">HommieCare</span>
                            </h1>
                    ...
                    <div className="p-8 md:p-16 space-y-12 text-slate-600 leading-relaxed text-lg">
                        ...
                        <section>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                                    ...
                                    <p className="text-sm text-slate-500">Direct employees of HommieCare Inc. involved in tech, marketing, and operations.</p>
                                </div>
                        ...
                        <section>
                            ...
                            <p>
                                In accordance with <strong>Article 27 of the Constitution of Kenya</strong> and the <strong>Employment Act (2007)</strong>, HommieCare is an equal opportunity employer. We do not discriminate on the basis of race, religion, color, national origin, gender, sexual orientation, age, marital status, or disability status.
                            </p>
                        </section>
                        ...
                        <section className="bg-red-50 rounded-3xl p-8 border border-red-100">
                            ...
                            <p className="text-red-800 font-medium mb-4">
                                Please be advised that HommieCare:
                            </p>
                            <ul className="list-disc pl-6 space-y-2 text-red-700 text-sm md:text-base">
                                ...
                                <li>Only communicates through <strong>@HommieCare.co.ke</strong> or official channels.</li>
                        ...
                        <section>
                            ...
                            <p>
                                HommieCare maintains a zero-tolerance policy for academic or professional misrepresentation. All shortlisted candidates will undergo background checks, including verification of previous employment and criminal record checks where required for the role.
                            </p>
                        </section>
                        ...
                        <section className="bg-white text-black rounded-[2rem] p-10 text-center">
                            ...
                            <div className="inline-block bg-white/10 backdrop-blur-md px-8 py-4 rounded-2xl border border-white/10">
                                <p className="font-bold text-lg">careers@HommieCare.co.ke</p>
                            ...
                            <p className="text-[10px] text-slate-500 mt-6 italic">
                                HommieCare is a registered trademark. Unauthorized use of our brand for recruitment is a criminal offense.
                            </p>
                        </section>
                ...
                <div className="mt-12 text-center text-slate-400 text-sm font-medium">
                    <p>© {new Date().getFullYear()} HommieCare Inc. Built in Nairobi, for the World.</p>
                </div>
            </div>
        </div>
    );
